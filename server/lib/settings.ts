...
export const settingFields: SettingField[] = [
  ...
  { group: 'Connections', key: 'jobber_webhook_auth_header', label: 'Jobber webhook Authorization header', type: 'text', secret: true, plan: 'pro', feature: 'crmWebhooks', help: 'Optional. Use the exact value required by the endpoint, like Bearer sk_live_...' },
  ...
  { group: 'Pricing', key: 'service_plans', label: 'Service plan definitions', type: 'textarea', rows: 8, public: true },
